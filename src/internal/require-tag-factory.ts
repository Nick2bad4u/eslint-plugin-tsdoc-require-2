...
type TagRuleModule = TSESLint.RuleModule<
    TagRuleMessageIds,
    TagRuleOptions,
    RuleDocs
>;
...
const createTagRule: RuleCreatorWithLanguages<RuleDocs> =
    createRuleCreator<RuleDocs>(
        (ruleName) =>
...
const createRequireTagRuleListener = (
    ...
    const checkProgram = (programNode: Readonly<TSESTree.Program>): void => {
