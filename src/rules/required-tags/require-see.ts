...
/** Rule module for `tsdoc-require-2/require-see`. */
const RequireSeeRule: TagRuleModule = createTagRule<
    TagRuleOptions,
    TagRuleMessageIds
>({
    create: (context: TagRuleContext) =>
        createRequireTagRuleListener(context, "@see"),
    meta: {
        defaultOptions: [
            {
        ...
        docs: {
            description:
                "require @see tag in TSDoc blocks for TypeScript declarations and default exports.",
            frozen: false,
            recommended: false,
        ...
        messages: {
            missingTag:
                "TSDoc for {{entityKind}} {{entityName}} must include @see.",
        },
        schema: [optionSchema],
        type: "problem",
    },
