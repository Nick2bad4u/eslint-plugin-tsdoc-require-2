...
/** Rule module for `tsdoc-require-2/require-example`. */
...
>({
    ...
    meta: {
        ...
        docs: {
            description:
                "require @example tag in TSDoc blocks for TypeScript declarations and default exports.",
            frozen: false,
            recommended: false,
        ...
        messages: {
            missingTag:
                "TSDoc for {{entityKind}} {{entityName}} must include @example.",
        },
        schema: [optionSchema],
        type: "problem",
    },
