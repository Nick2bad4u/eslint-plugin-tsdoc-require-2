...
/** Rule module for `tsdoc-require-2/require-internal`. */
...
>({
    ...
    meta: {
        ...
        docs: {
            description:
                "require @internal tag in TSDoc blocks for TypeScript declarations and default exports.",
            frozen: false,
            recommended: false,
        ...
        messages: {
            missingTag:
                "TSDoc for {{entityKind}} {{entityName}} must include @internal.",
        },
        schema: [optionSchema],
        type: "problem",
    },
