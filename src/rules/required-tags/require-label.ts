...
/** Rule module for `tsdoc-require-2/require-label`. */
...
>({
    ...
    meta: {
        ...
        docs: {
            description:
                "require @label tag in TSDoc blocks for TypeScript declarations and default exports.",
            frozen: false,
            recommended: false,
        ...
        messages: {
            missingTag:
                "TSDoc for {{entityKind}} {{entityName}} must include @label.",
        },
        schema: [optionSchema],
        type: "problem",
    },
