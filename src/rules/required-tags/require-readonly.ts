...
/** Rule module for `tsdoc-require-2/require-readonly`. */
...
>({
    ...
    meta: {
        ...
        docs: {
            description:
                "require @readonly tag in TSDoc blocks for TypeScript declarations and default exports.",
            frozen: false,
            recommended: false,
        ...
        messages: {
            missingTag:
                "TSDoc for {{entityKind}} {{entityName}} must include @readonly.",
        },
        schema: [optionSchema],
        type: "problem",
    },
