...
/** Rule module for `tsdoc-require-2/require-package-documentation`. */
...
>({
    ...
    meta: {
        ...
        docs: {
            description:
                "require @packageDocumentation tag in TSDoc blocks for TypeScript declarations and default exports.",
            frozen: false,
            recommended: false,
        ...
        messages: {
            missingTag:
                "TSDoc for {{entityKind}} {{entityName}} must include @packageDocumentation.",
        },
        schema: [optionSchema],
        type: "problem",
    },
