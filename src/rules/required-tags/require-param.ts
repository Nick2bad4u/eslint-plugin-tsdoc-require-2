...
/** Rule module for `tsdoc-require-2/require-param`. */
const RequireParamRule: TagRuleModule = createTagRule<
    TagRuleOptions,
    TagRuleMessageIds
>({
    create: (context: TagRuleContext) =>
        createRequireTagRuleListener(context, "@param"),
    meta: {
        defaultOptions: [
            {
        ...
        docs: {
            description:
                "require @param tag in TSDoc blocks for TypeScript declarations and default exports.",
            frozen: false,
            recommended: false,
        ...
        messages: {
            missingTag:
                "TSDoc for {{entityKind}} {{entityName}} must include @param.",
        },
        schema: [optionSchema],
        type: "problem",
    },
