...
/** Rule module for `tsdoc-require-2/require-type-param`. */
const RequireTypeParamRule: TagRuleModule = createTagRule<
    TagRuleOptions,
    TagRuleMessageIds
>({
    ...
    meta: {
        ...
        docs: {
            description:
                "require @typeParam tag in TSDoc blocks for TypeScript declarations and default exports.",
            frozen: false,
            recommended: false,
        ...
        messages: {
            missingTag:
                "TSDoc for {{entityKind}} {{entityName}} must include @typeParam.",
        },
        schema: [optionSchema],
        type: "problem",
    },
