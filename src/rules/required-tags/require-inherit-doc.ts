...
/** Rule module for `tsdoc-require-2/require-inherit-doc`. */
...
>({
    ...
    meta: {
        ...
        docs: {
            description:
                "require @inheritDoc tag in TSDoc blocks for TypeScript declarations and default exports.",
            frozen: false,
            recommended: false,
        ...
        messages: {
            missingTag:
                "TSDoc for {{entityKind}} {{entityName}} must include @inheritDoc.",
        },
        schema: [optionSchema],
        type: "problem",
    },
