...
/** Rule module for `tsdoc-require-2/require-decorator`. */
const RequireDecoratorRule: TagRuleModule = createTagRule<
    TagRuleOptions,
    TagRuleMessageIds
>({
    ...
    meta: {
        ...
        docs: {
            description:
                "require @decorator tag in TSDoc blocks for TypeScript declarations and default exports.",
            frozen: false,
            recommended: false,
        ...
        messages: {
            missingTag:
                "TSDoc for {{entityKind}} {{entityName}} must include @decorator.",
        },
        schema: [optionSchema],
        type: "problem",
    },
...
export default RequireDecoratorRule;
