...
/** Rule module for `tsdoc-require-2/require-deprecated`. */
...
>({
    ...
    meta: {
        ...
        docs: {
            description:
                "require @deprecated tag in TSDoc blocks for TypeScript declarations and default exports.",
            frozen: false,
            recommended: false,
        ...
        messages: {
            missingTag:
                "TSDoc for {{entityKind}} {{entityName}} must include @deprecated.",
        },
        schema: [optionSchema],
        type: "problem",
    },
