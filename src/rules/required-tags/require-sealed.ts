...
/** Rule module for `tsdoc-require-2/require-sealed`. */
...
>({
    ...
    meta: {
        ...
        docs: {
            description:
                "require @sealed tag in TSDoc blocks for TypeScript declarations and default exports.",
            frozen: false,
            recommended: false,
        ...
        messages: {
            missingTag:
                "TSDoc for {{entityKind}} {{entityName}} must include @sealed.",
        },
        schema: [optionSchema],
        type: "problem",
    },
