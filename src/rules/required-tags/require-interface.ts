...
/** Rule module for `tsdoc-require-2/require-interface`. */
const RequireInterfaceRule: TagRuleModule = createTagRule<
    TagRuleOptions,
    TagRuleMessageIds
>({
    ...
    meta: {
        ...
        docs: {
            description:
                "require @interface tag in TSDoc blocks for supported TypeScript declarations and default exports.",
            frozen: false,
            recommended: false,
    ...
    name: "require-interface",
});

export default RequireInterfaceRule;
