...
>({
    ...
    meta: {
        ...
        docs: {
            description:
                "require @remarks tag in TSDoc blocks for exported TypeScript declarations and default exports.",
            frozen: false,
            recommended: false,
        ...
        messages: {
            missingTag:
                "TSDoc for exported {{entityKind}} {{entityName}} must include @remarks.",
        },
        schema: [optionSchema],
        type: "problem",
    },
