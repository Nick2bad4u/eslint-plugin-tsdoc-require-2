...
/** Rule module for `tsdoc-require-2/require-remarks`. */
const RequireRemarksRule: TagRuleModule = createTagRule<
    TagRuleOptions,
    TagRuleMessageIds
>({
    create: (context: TagRuleContext) =>
        createRequireTagRuleListener(context, "@remarks"),
    meta: {
        defaultOptions: [
            {
        ...
        docs: {
            description:
                "require @remarks tag in TSDoc blocks for TypeScript declarations and default exports.",
            frozen: false,
            recommended: false,
        ...
        messages: {
            missingTag:
                "TSDoc for {{entityKind}} {{entityName}} must include @remarks.",
        },
        schema: [optionSchema],
        type: "problem",
    },
