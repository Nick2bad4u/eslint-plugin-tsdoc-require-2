...
/** Rule module for `tsdoc-require-2/require-throws`. */
const RequireThrowsRule: TagRuleModule = createTagRule<
    TagRuleOptions,
    TagRuleMessageIds
>({
    ...
    meta: {
        ...
        docs: {
            description:
                "require @throws tag in TSDoc blocks for TypeScript declarations and default exports.",
            frozen: false,
            recommended: false,
        ...
        messages: {
            missingTag:
                "TSDoc for {{entityKind}} {{entityName}} must include @throws.",
        },
        schema: [optionSchema],
        type: "problem",
    },
