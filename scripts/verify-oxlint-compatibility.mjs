...
const namespace = plugin.meta.namespace ?? "tsdoc-require-2";
...
/**
 * @typedef This tag is intentionally in the default denylist.
 */
export const customTagged = true;
`;
...
const main = async () => {
    assert.equal(namespace, "tsdoc-require-2");
    assert.equal(ruleNames.length, 58);
        ...
        JSON.stringify(
            {
                ...
                diagnosticRuleCount: ruleNames.length,
