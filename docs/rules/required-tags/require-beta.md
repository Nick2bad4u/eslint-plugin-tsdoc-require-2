...
By default, this rule reports exported declarations (and supported default exports) that have TSDoc but are missing `@beta`. Set `includeNonExported: true` to also check non-exported top-level declarations.
